...
import '../cupertino/cupertino_progress_bar.dart';
import '../cupertino/widgets/cupertino_options_dialog.dart';
...
class _CupertinoControlsState extends State<CupertinoControls>
  ...
  void _skipForward() {
    ...
    final skip =
        (_latestValue.position + const Duration(seconds: 15)).inMilliseconds;
    controller.seekTo(Duration(milliseconds: math.max(skip, end)));
  }
